...
export default function Comment({ id }) {
  ...
  return (
    <Layout>
      <Head>
        <title>WebTech - Commentaire article</title>
        <meta name="description" content="Generated by create next app" />
        <link rel="icon" href="/cyberpunk.png" />
      </Head>
      <h2 className="wt-title text-center mt-3 text-primary">
        Envoie moi un{" "}
        <span className="underline decoration-sky-500 text-primary">commentaire</span> :
      </h2>
      ...
      <br />
      <h3 className="text-primary wt-title mt-4 mb-2 text-center text-2xl font-bold tracking-wide leading-7 text-white-900 sm:text-3xl sm:truncate">
        Mon email :
      </h3>

      <p className="text-primary text-center font-bold tracking-wide  text-white-900 sm:truncate hover:text-blue-500">
