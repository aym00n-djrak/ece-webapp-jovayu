...
export default function ArticlesUpdate({ id }) {
  ...
  return (
    <Layout>
      ...
      <h1 className="wt-title">Modifie l article {id}:</h1>
      ...
      <form className="[&_span]:block grid gap-3 mt-4 mb-8 w-full max-w-[30rem] mx-auto text-slate-500 text-sm font-medium tracking-wide leading-6 space-y-4 sm:space-y-0 sm:grid-cols-2 sm:gap-6 sm:items-start sm:text-base" onSubmit={onSubmit}>
        <div>
          <label>
            <span>Titre</span>
            <input type="text" name="titre" text={articles?.titre} onChange={(e) => setArticle(e.target.value)} />
          </label>
        </div>
        <div>
          <label>
            <span>Contenu</span>
            <input type="text" name="contenu" text={articles?.contenu} onChange={(e) => setArticle(e.target.value)} />
          </label>
        </div>
        <div>
          <label>
            <span>Auteur</span>
            <input type="text" name="auteur" text={articles?.auteur} onChange={(e) => setArticle(e.target.value)} />
          </label>
        </div>
        <div>
